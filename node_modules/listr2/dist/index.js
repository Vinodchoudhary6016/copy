  ...
  getSelfOrParentOption(task, key) {
    ...
    return (
      ((_a2 = task == null ? void 0 : task.rendererOptions) == null
        ? void 0
        : _a2[key]) ?? ((_b = this.options) == null ? void 0 : _b[key])
    );
  }
  getTaskTime(task) {
      ...
      Object.assign(option, {
        stdout:
          this instanceof TaskWrapper
            ? (settings == null ? void 0 : settings.stdout) ?? this.stdout()
            : process.stdout,
...
var TaskWrapper = class {
  ...
  report(error, type) {
    ...
    this.task.message$ = {
      error:
        error.message ??
        ((_a2 = this.task) == null ? void 0 : _a2.title) ??
        "Task with no title.",
    };
  }
  skip(message) {
...
var Listr = class {
  ...
  add(task) {
    ...
    tasks.forEach((task2) => {
      this.tasks.push(
        new Task(this, task2, this.options, {
  ...
  async run(context) {
    ...
    this.ctx =
      ((_a2 = this.options) == null ? void 0 : _a2.ctx) ?? context ?? {};
